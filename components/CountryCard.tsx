...
export default function CountryCard({ country, index = 0, locale = "en" }: { country: Country; index?: number; locale?: Locale }) {
  ...
  return (
    ...
    >
      ...
      >
        <Globe2 className="w-5 h-5 text-violet" />
        ...
        <span className="mt-4 inline-flex items-center gap-1.5 text-sm font-medium text-saffron group-hover:gap-2.5 transition-all">
          {t.learnMore}
